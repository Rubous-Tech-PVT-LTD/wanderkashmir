    ...
    <aside className="w-64 bg-slate-950 text-white min-h-screen flex flex-col hidden md:flex sticky top-0 h-screen border-r border-slate-800">
      <div className="p-6 border-b border-slate-800">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight">WanderKashmir Admin</span>
        </Link>
      </div>
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        {links.map((link) => {
          ...
          return (
            ...
            >
              <Icon className="w-5 h-5 text-slate-400 group-hover:text-orange- transition-colors" />
      ...
      <div className="p-4 border-t border-slate-800 bg-slate-900/50">
        <div className="flex items-center gap-3 px-3 py-2">
          <div className="w-10 h-10 rounded-full bg-orange-/20 flex items-center justify-center text-orange- font-bold border border-orange-/30">
            A
          </div>
