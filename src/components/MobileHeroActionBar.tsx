            ...
            <div className="w-full grid grid-cols-3 gap-2">
              ...
              >
                ...
                <div className="flex flex-col text-left leading-tight min-w-0">
                  ...
                  <span className="text-[9px] text-pink-600 font-semibold truncate max-w-[65px]">wanderkashmir__</span>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex flex-col text-left leading-none">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[12px] font-black text-slate-800">{displayRating}</span>
                  </div>
                  <span className="text-[9px] text-slate-500 font-medium mt-0.5 whitespace-nowrap">{displayReviews}</span>
                </div>
              </a>
            </div>
