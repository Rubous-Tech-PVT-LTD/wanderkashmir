        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="sticky top-24 space-y-6 hidden lg:block mt-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                ...
                <div className="mt-5 pt-4 border-t border-slate-100">
                  <button className="text-orange-500 font-semibold text-sm hover:text-orange-500 transition-colors">
                    Show 6 more
                  </button>
                </div>
              </div>
          ...
          <div className="flex-1 space-y-6">
            {filtered.map((property) => (
              <div key={property.id} className="bg-white border border-orange-500 rounded-lg shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row md:h-[230px] overflow-hidden">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <Link href={`/stays/${property.id}`}>
                        <h3 className="text-xl font-bold text-slate-900 cursor-pointer hover:text-orange-500 transition-colors">
                          {property.name}
                        </h3>
                      </Link>
                    ...
                    <p className="text-sm text-slate-600 mb-3">
                      <Link href={`/stays/${property.id}`}>
                        <span className="text-orange-500 hover:underline cursor-pointer">{property.location}</span>
                      </Link> 
                ...
                <div className="w-full md:w-56 p-5 border-t md:border-t-0 md:border-l border-slate-100 flex flex-col justify-between bg-white md:rounded-r-lg relative">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-sm font-bold text-orange-500">Very Good</span>
                  ...
                  <div className="mt-8 flex flex-col items-end text-right">
                    ...
                    <Link href={`/stays/${property.id}`} className="text-sm font-bold text-orange-500 hover:text-orange-500 hover:underline">
