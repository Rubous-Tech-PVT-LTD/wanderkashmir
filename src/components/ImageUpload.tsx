              ...
              >
                {({ open }) => (
                  <button 
                    type="button" 
                    onClick={() => open()}
                    className="w-24 h-24 border-2 border-dashed border-slate-300 rounded-lg flex flex-col items-center justify-center text-slate-500 hover:bg-orange-500 hover:border-orange-500 hover:text-orange-500 transition-colors shrink-0"
                  >
