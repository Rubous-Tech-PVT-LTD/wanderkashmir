        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              {[
                { Icon: InstagramIcon, href: "https://instagram.com/wanderkashmir", label: "Instagram" },
                ...
                { Icon: LinkedinIcon, href: "https://linkedin.com/company/wanderkashmir", label: "LinkedIn" },
              ].map(({ Icon, href, label }) => (
                <a
                  key={label}
                  href={href}
