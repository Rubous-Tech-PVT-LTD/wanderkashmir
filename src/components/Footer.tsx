        ...
        <div className="container-custom flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            <input
              ...
              className="flex-1 md:w-72 px-4 py-3 rounded-xl bg-white text-slate-900 placeholder:text-slate-500 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-white"
            />
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-5 group">
              <div className="w-9 h-9 flex items-center justify-center">
                <img src="/brand-icon.webp" alt="WanderKashmir logo" className="w-full h-full object-cover rounded-md shadow-sm" />
              </div>
            ...
            <div className="flex gap-3">
              {[
                { Icon: InstagramIcon, href: "https://www.instagram.com/wanderkashmir__/", label: "Instagram" },
