...
export default function HomestayClient({ vendorProfileId, bookings = [], properties = [] }: { vendorProfileId: string, bookings?: any[], properties?: any[] }) {
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            {subscriptionPlan !== "Free" && (
              <span className="bg-gradient-to-r from-orange-500 to-orange-600 text-orange-500 text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1 uppercase tracking-wider shadow-sm">
      ...
      {activeTab === "financials" && (
        <div className="space-y-8">
          <div className="bg-orange-500 border border-orange-500 rounded-2xl p-6">
            <h2 className="text-xl font-bold text-orange-500 mb-2">Welcome Homestay Host!</h2>
            <p className="text-orange-500">You enjoy our special lowest commission tier of 8% to help grow local tourism. Choose a subscription plan to boost visibility.</p>
          </div>
              ...
              {subscriptionTiers.map((tier) => {
                ...
                return (
                  <div key={tier.name} className={`bg-white rounded-2xl border relative ${isActive ? 'border-orange-500 shadow-md ring-4 ring-orange-500' : tier.isPopular ? 'border-orange-500 shadow-md' : 'border-slate-200 shadow-sm'} p-6 flex flex-col transition-all`}>
                    {tier.isPopular && !isActive && <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-orange-500 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">Most Popular</span>}
                    {isActive && (
                ...
                {properties.map((prop: any) => (
                  <div key={prop.id} className="p-6 flex items-center justify-between hover:bg-slate-50 transition-colors">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs font-semibold text-orange-500 mt-1">Up to {prop.totalRooms * 2} Guests</p>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className={`w-full border rounded-lg pl-10 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-orange-500/20 bg-white ${errors.basePrice ? 'border-orange-500 focus:border-orange-500' : 'border-slate-200 focus:border-orange-500'}`} 
                        placeholder="1500" 
                      />
                    </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className={`w-full border rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-orange-500/20 ${errors.maxGuests ? 'border-orange-500 focus:border-orange-500' : 'border-slate-200 focus:border-orange-500'}`} 
                    placeholder="4" 
                  />
