...
export default function VendorEntryPage() {
  ...
  const FileUploadBox = ({ title, desc }: { title: string, desc: string }) => (
    <div className="border-2 border-dashed border-slate-200 rounded-xl p-6 flex flex-col items-center justify-center text-center hover:bg-slate-50 transition-colors cursor-pointer group">
      <div className="w-10 h-10 bg-slate-100 text-slate-500 rounded-full flex items-center justify-center mb-3 group-hover:bg-orange-500 group-hover:text-white transition-colors">
            ...
            {step === 2 && (
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="mt-8 border-t border-slate-100 pt-8">
                  ...
                  }} className="text-sm bg-orange-500 text-white px-4 py-2 rounded-lg font-bold hover:bg-orange-500 transition-colors">
