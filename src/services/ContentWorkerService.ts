...
The 5th (final) slide MUST contain a Call To Action (CTA) encouraging users to save, share, or visit WanderKashmir.
...
Return JSON format: { "message": string }`;
    ...
    return `You are the Content Distribution Agent for WanderKashmir.
